<template>
    <div>
        <div style="margin: 10px 0">
            ...
            <el-input style="width: 200px" placeholder="请输入评论人" suffix-icon="el-icon-search" v-model="userNickname"></el-input>
            <el-input style="width: 200px" class="ml-5"  placeholder="请输入内容关键字" suffix-icon="el-icon-search" v-model="content"></el-input>
        ...
        >
            ...
            <el-table-column prop="userNickname" label="评论人" width="120"></el-table-column>
            <el-table-column prop="parentCommentId" label="父级id" width="120"></el-table-column>
            <el-table-column prop="articleId" label="文章id" width="85"></el-table-column>
...
<script>
    export default {
        ...
        methods:{
            // 从后台获取数据，并在页面中赋值
            async load() {
                await this.request.get("/comment/page", {
            ...
            // 失效触发
            del(id) {
                this.request.delete("/comment/del/" + id).then(res => {
                    if (res.code === "200") {
